   ...
   do                 
      ...
      do                         
         ...
         $HADOOP_PATH/hadoop jar $HADOOP_MR/hadoop-examples.jar teragen \
                     ...
                     100000000 /results/tg-1GB-${i}-${j}-${k} 1>tera_${i}_${j}_${k}.out 2>tera_${i}_${j}_${k}.err                       
         ...
         $HADOOP_PATH/hadoop jar $HADOOP_MR/hadoop-examples.jar terasort \
                     ...
                     /results/tg-1GB-${i}-${j}-${k} /results/ts-1GB-${i}-${j}-${k} \
                     1>>tera_${i}_${j}_${k}.out 2>>tera_${i}_${j}_${k}.err                         

          $HADOOP_PATH/hadoop fs -rmr -skipTrash /results/tg-1GB-${i}-${j}-${k}                         
          $HADOOP_PATH/hadoop fs -rmr -skipTrash /results/ts-1GB-${i}-${j}-${k}                 
      done
   done
done
